 ...
 */
public class DesHabilitarNearField implements Runnable {

    public FragmentActivity fragmentActivity;

    public DesHabilitarNearField(FragmentActivity fragmentActivity)
    {
    ...
    public void run()
    {
        if(  ((HomeActivity) fragmentActivity).controladorServiceBLE!=null)
            ((HomeActivity) fragmentActivity).controladorServiceBLE.desHabilitarNearField();
