...
public class RendererFragment extends Fragment implements ISceneController
{
	...
	//*********************************************************************************************
	//LA VISTA SE CREARA EN EL FRAGMENTO EN onCreateView a diferencia de RenderActivity
	//*********************************************************************************************
	//*********************************************************************************************
	...
	/*public void stopRunnable()
	{
		...
		_initSceneHander.removeCallbacks(_initSceneRunnable);
		_updateSceneHander.removeCallbacks(_updateSceneRunnable);
